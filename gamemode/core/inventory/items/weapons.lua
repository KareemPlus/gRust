...
gRust.ItemRegister("admin_gun")
:SetName("WTF! ITS ADMIN GUN!")
:SetDescription("it just destroys everyone")
:SetIcon("materials/icons/skull.png")
:SetStack(1)
:SetCondition(true)
:SetWeapon("rust_admingun")
:SetModel("models/weapons/darky_m/rust/w_python.mdl")
:SetMaterial("Gun")
:AddToCategory("Fun")
:SetCraftable(false)
...
gRust.ItemRegister("admin_cucumber")
:SetName("Terminator2000")
:SetDescription("Eto pizdec.")
:SetIcon("materials/icons/gestures/sexy_dance.png")
:SetStack(1)
:SetCondition(true)
:SetWeapon("admin_cucumber")

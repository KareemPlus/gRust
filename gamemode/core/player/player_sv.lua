...
function GM:PlayerLoadout(pl)
    ...
    -- Loadout
    --
    --local stone = gRust.CreateItem("stones")
    --local wood = gRust.CreateItem("wood")
    --local metal = gRust.CreateItem("metal_fragments")
    --local hq = gRust.CreateItem("hq_metal")
    local hat = gRust.CreateItem("hatchet")
    local ak = gRust.CreateItem("pickaxe")
    --local haz = gRust.CreateItem("hazmat_suit")
    --local aka = gRust.CreateItem("556_rifle_ammo")
    --local med = gRust.CreateItem("medical_syringe")
    local bad = gRust.CreateItem("bandage")
    --stone:SetQuantity(5000)
    --wood:SetQuantity(10000)
    --metal:SetQuantity(2500)
    --hq:SetQuantity(250)
    bad:SetQuantity(5)
    hat:SetQuantity(1)
    --med:SetQuantity(100)
    ...
    pl.Belt:Set(1, ak)
    pl.Attire:Set(1, haz)
    pl.Inventory:Set(1, aka)
    pl.Inventory:Set(2, stone)
    pl.Inventory:Set(3, wood)
    pl.Inventory:Set(4, metal)
    pl.Inventory:Set(5, hq)
end
